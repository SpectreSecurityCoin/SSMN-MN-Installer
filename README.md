...
If you require further assistance contact the support team @ [Discord](https://discord.gg/CcsuQpvKNY)
***
## Requirements
...
***Step 1***
* Download and install the SpectreSecurity Masternode wallet [here](https://github.com/SpectreSecurityCoin/SpectreSecurityMN/releases)
***

***Step 2***
* Send EXACLY 10,000 SSMN to a receive address within your wallet.
***
...
`spectresecurity-cli masternode status`

`spectresecurity-cli getinfo`

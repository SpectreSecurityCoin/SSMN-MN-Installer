...
SPECTRESECURITY_LATEST_RELEASE="https://github.com/SpectreSecurityCoin/SpectreSecurityMN/releases/download/5.6.1/spectresecuirty-5.6.1-ubuntu-18-daemon.zip"
...
function install_params() {
  ...
  wget $SPECTRESECURITY_PARAMS >/dev/null 2>&1
...
function copy_spectresecurity_binaries(){
  ...
  wget -v $SPECTRESECURITY_LATEST_RELEASE
